...
EVAL_TAG=${EVAL_TAG:-exactphase_transfer_20260615}
EVAL=$SCR/pace_flowtiming_eval/$EVAL_TAG
BASE_TAG=${BASE_TAG:-exactphase_base_20260615}
SELF_TAG=${SELF_TAG:-exactphase_self_20260615}

TOPO_T1=$SCR/pace_flowtiming_eval/blackscholes_t1_inter25_20260609/topology.json

DEDUP_T0=$SCR/fullsys_flowstats_exactphase/dedup_c16_l2256kB_d4_mc1_T0_mesh_ll1_rl1_w128_${BASE_TAG}
CANNEAL_T0=$SCR/fullsys_flowstats_exactphase/canneal_c16_l2256kB_d4_mc1_T0_mesh_ll1_rl1_w128_${BASE_TAG}
BLACKSCHOLES_T0=$SCR/fullsys_flowstats_exactphase/blackscholes_c16_l2256kB_d4_mc1_T0_mesh_ll1_rl1_w128_${BASE_TAG}
DEDUP_T1=$SCR/fullsys_flowstats_exactphase/dedup_c16_l2256kB_d4_mc1_T1_inter25_ll1_rl1_w128_${SELF_TAG}

...
CASES = [
    {
        ...
        "packets": [
            ...
            {"cycle": 4, "source": 3, "destination": 1, "vnet": 2,
             "message_size": 8, "flits": 1},
            {"cycle": 8, "source": 0, "destination": 3, "vnet": 1,
    ...
    },
    {
        ...
        "packets": [
            {"cycle": 0, "source": 0, "destination": 5, "vnet": 0,
             "message_size": 8, "flits": 1},
            {"cycle": 3, "source": 1, "destination": 4, "vnet": 2,
             "message_size": 8, "flits": 1},
            {"cycle": 6, "source": 4, "destination": 3, "vnet": 1,
             "message_size": 72, "flits": 5},
        ],
    ...
    },
    {
        ...
        "packets": [
            {"cycle": 0, "source": 0, "destination": 2, "vnet": 0,
             "message_size": 8, "flits": 1},
            {"cycle": 2, "source": 1, "destination": 3, "vnet": 2,
             "message_size": 8, "flits": 1},
            {"cycle": 4, "source": 3, "destination": 0, "vnet": 1,
             "message_size": 72, "flits": 5},
        ],
